...
### 📈 [PC Hardware Price Predictor](https://pc-forecaster-iota.vercel.app)
> **Python · SQL · SQLite · Pandas · Claude Code** - *Live at [pc-forecaster-iota.vercel.app](https://pc-forecaster-iota.vercel.app)*  
...
Complete Android photo management app ported from a JavaFX desktop project. **4 OOP model classes** restructured with clean separation of concerns, **6 user-facing features**, tested across 3+ emulator configurations.
...
- Built **JavaScript QR-code attendance** for live investor events (**26 tests**)
- Refactored a **9,000-line React client** and introduced its **first automated tests (123 cases)**
...
![Codex](https://img.shields.io/badge/OpenAI%20Codex-412991?style=flat-square&logo=openai&logoColor=white)
![Cursor](https://img.shields.io/badge/Cursor-000000?style=flat-square&logo=githubcopilot&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini%20CLI-4285F4?style=flat-square&logo=google&logoColor=white)
